...
TRON::TRON(const function *fun_obj, double eps, long long max_iter)
{
...
void TRON::tron(double *w)
{
	...
	long long n = fun_obj->get_nr_variable();
	long long i, cg_iter;
	double delta, snorm, one=1.0;
	double alpha, f, fnew, prered, actred, gs;
	long long search = 1, iter = 1, inc = 1;
...
long long TRON::trcg(double delta, double *g, double *s, double *r)
{
	long long i, inc = 1;
	long long n = fun_obj->get_nr_variable();
	double one = 1;
...
double TRON::norm_inf(long long n, double *x)
{
